    ...
    Column buildQuestion(Question question){
      return Column(
        ...
        children: [
          ...
          Text(
            question.text,
            style: const TextStyle(fontSize: 16,color: Color.fromARGB(255, 3, 65, 29),fontWeight: FontWeight.w500,wordSpacing: 6.5,fontFamily: 'Padauk'),
          ),
            const SizedBox(height: 32),
            Expanded(
              child: OptionsWidget(
      ...
      child: Container(
        ...
        child: Row(
                ...
                children: [
                   Text(
                    option.text,
                    style: const TextStyle(color:Color.fromARGB(255, 3, 54, 95),fontSize: 15,fontWeight: FontWeight.w500,fontFamily: ''),
                   ),
 ...
 class ResultPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
        return MaterialApp(
           ...
           body: Center( 
            child: Text('Your Score is   [ $score/${questions.length} ]',style: TextStyle(color:Color.fromARGB(255, 3, 72, 128),fontSize: 20,fontFamily: 'Padauk'),),
           ),
